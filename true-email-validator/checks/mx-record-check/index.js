...
import blacklist from './blacklist-email-domains.json' assert { type: 'json' }
...
export const isValidSync = (email) => {
...
export const isValid = async (email) => {
  if (typeof email !== 'string') {
    return false
  }
  email = email.toLowerCase()
